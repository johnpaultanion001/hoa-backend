...
use Api\V1_0_0\Services\Inquiry\InquiryService;
...
class InquiryController extends Controller
{
     ...
     * @param InquiryService $service
     * @param UserService $userService
     */
    public function __construct(InquiryService $service, UserService $userService)
	{
